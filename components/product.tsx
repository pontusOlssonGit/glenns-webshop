      ...
      <section>
        <div className="flex flex-col gap-4">
            <div>
               ...
               <div>
                <h2 className="font-extrabold">Recensioner{product.reviews ? ` (${product.reviews.length})` : ""}</h2>
                <ul className="flex flex-col gap-4">
                    {product.reviews?.map((review, index) => (
                        <li key={index} className="flex flex-col items-start gap-2 pt-4 pb-4 border-b border-gray-300">
                            <div className="flex flex-row items-center gap-2">
                                <span className="bg-[#0004ff] p-3 rounded-full"><User2 className="w-6 h-6 text-white" /></span>
                                <div>
