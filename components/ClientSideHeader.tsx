...
export default function Header({ user }: { user: any }) {
  const categories = {
    Mat: {
      ...
      icon: <Ham className="w-5 h-5 stroke-gray-900" />,
    },
    Kläder: {
      subcategories: ["Herrskjortor", "Herr-tshirts", "Klänningar"],
      icon: <ShirtIcon className="w-5 h-5 stroke-gray-900" />,
    },
    Elektronik: {
      subcategories: [
        "Tablets",
      ...
      icon: <LucideTv className="w-5 h-5 stroke-gray-900" />,
    },
    Sport: {
      subcategories: [
        "Sportutrustning",
      ...
      icon: <Volleyball className="w-5 h-7 stroke-gray-900" />,
    },
    Skor: {
      subcategories: ["Idrottsskor", "Sportskor", "Slippers"],
      icon: <Footprints className="w-5 h-5 stroke-gray-900" />,
    },
    Kök: {
      subcategories: [
        "Bricka",
      ...
      icon: <CookingPot className="w-5 h-5 stroke-gray-900" />,
    },
    Fordon: {
      subcategories: ["Sporthoj", "Motorcyklar", "Suv"],
      icon: <CarFront className="w-5 h-5 stroke-gray-900" />,
    },
    Djur: {
      subcategories: ["Hundmat", "Kattmat", "Djurtillbehör"],
      icon: <Cat className="w-5 h-5 stroke-gray-900" />,
    },
    Möbler: {
      subcategories: ["Soffor", "Sängar", "Sängbord"],
      icon: <Sofa className="w-5 h-5 stroke-gray-900" />,
    },
  };
  return (
      ...
      <div className="w-full relative bg-[#333] flex pl-10 pr-10 lg:pl-35 lg:pr-35">
        <ul className="grid grid-cols-3 lg:flex lg:flex-row w-full justify-around text-center text-white text-xs font-semibold">
          {Object.keys(categories).map((category: string) => (
            <li key={category} className="w-full hover:bg-[#1a1a1d] p-2 group">
              {category}

              <div className="absolute z-40 left-0 pl-10 pr-10 lg:pl-35 lg:pr-35 w-full hidden pt-2 group-hover:block ">
